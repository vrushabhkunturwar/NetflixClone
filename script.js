document.addEventListener('DOMContentLoaded', function () {
    ...
    const faqItems = [
        ...
        { question: 'How much dose Netflix cost?', answer: 'Watch Netflix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from ₹149 to ₹649 a month. No extra costs, no contracts.' },
    ...
    // Populate the FAQ section with items
